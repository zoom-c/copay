module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      ...
      linux: {
        files: [
          {expand: true, cwd: 'webkitbuilds/',src: ['.desktop', '../public/img/icons/favicon.ico', '../public/img/icons/icon-256.png'],dest: 'webkitbuilds/zoom/linux32/', flatten: true, filter: 'isFile' },
          {expand: true, cwd: 'webkitbuilds/',src: ['.desktop', '../public/img/icons/favicon.ico', '../public/img/icons/icon-256.png'],dest: 'webkitbuilds/zoom/linux64/', flatten: true, filter: 'isFile' },
        ],
      }
    },
    karma: {
